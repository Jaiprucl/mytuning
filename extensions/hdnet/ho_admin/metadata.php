...
$aModule = array(
    ...
    'extend' => array(
		'hdnet\ho_admin\application\views\ho_vexport' => 'ho_admin/application/views/ho_vexport',
		'hdnet\ho_admin\application\views\ho_vimport' => 'ho_admin/application/views/ho_vimport',
		'hdnet\ho_admin\application\views\ho_picture' => 'ho_admin/application/views/ho_picture',
        ArticleListController::class                => 'ho_admin/admin/ho_alist',
        SearchController::class                     => 'ho_admin/admin/ho_search',
    ),
    'files' => array(
        'hdnet\ho_admin\admin\ho_file' => 'ho_admin/admin/ho_file.php',
        'hdnet\ho_admin\admin\ho_adminer' => 'ho_admin/admin/ho_adminer.php',
        'hdnet\ho_admin\admin\ho_export' => 'ho_admin/admin/ho_export.php',
        'hdnet\ho_admin\admin\ho_import' => 'ho_admin/admin/ho_import.php',
        'hdnet\ho_admin\admin\ho_logs' => 'ho_admin/admin/ho_logs.php',
        'hdnet\ho_admin\admin\ho_admindetails' => 'ho_admin/admin/ho_admindetails.php',
		'hdnet\ho_admin\application\views\ho_vexport' => 'ho_admin/application/views/ho_vexport.php',
		'hdnet\ho_admin\application\views\ho_vimport' => 'ho_admin/application/views/ho_vimport.php',
		'hdnet\ho_admin\application\views\ho_picture' => 'ho_admin/application/views/ho_picture.php',
    ),
    'templates' => array(
