...
use Excetion;
use extensions\ho_admin\admin\Exception;
...
class ho_import extends AdminController
{
    ...
    public function getCsvCount($key)
    {
        ...
        switch ($key) {
            case("article"):
                $_sThisimportFile = $_sThisImportConfig->getConfigParam("HO_CSV_CSR_ARTICLE");
                break;
            case("picture"):
                $_sThisimportFile = $_sThisImportConfig->getConfigParam("HO_CSV_CSR_PICTURE");
                break;
        }
    ...
    public function getCsvData($csv)
    {
        ...
        switch ($csv) {
            case("article"):
                $_sThisExportFile = $_sThisExportConfig->getConfigParam("HO_CSV_CSR_ARTICLE");
                break;
            case("user"):
                $_sThisExportFile = $_sThisExportConfig->getConfigParam("HO_CSV_CSR_USER");
                break;
            case("picture"):
                $_sThisExportFile = $_sThisExportConfig->getConfigParam("HO_CSV_CSR_ARTICLE");
                break;
    ...
    public function getShippingValue($value)
    {
        switch ($value) {
            ...
            case("29.93 EUR"):
                ...
                break;
            default:
                ho_import::setLog("shipping", "Konnte $value nicht finden");
        }
