 ...
 * @package admin
 */
class hd_admindetails extends oxAdminView
{
    /**
    ...
    protected function _getTextEditor($iWidth, $iHeight, $oObject, $sField, $sStylesheet = null)
    {
        if ($this->_oEditor === null) {
            ...
            if ($sEditorFile && file_exists($sEditorFile)) {
                ...
                $sEditorUrl = $myConfig->getConfigParam('sShopURL') ./*$myConfig->getConfigParam( 'sAdminDir' ).*/
                    "core/{$sEditorPath}/";
    ...
    {
        $oUtils = Registry::get("oxUtilsCount");
