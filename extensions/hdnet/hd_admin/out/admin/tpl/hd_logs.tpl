...
<link rel="stylesheet" href=" ../modules/hdnet/hd_admin/out/src/css/tabs.css">
...
<h2 style="margin: 1px;">[{ oxmultilang ident="HD_LOGS_TITLE" }]</h2>
<br>
<div id="tabs">
  <ul>
    <li><a href="#tabs-1">[{ oxmultilang ident="HD_LOG_TABS_ORDER" }]</a></li>
    <li><a href="#tabs-2">[{ oxmultilang ident="HD_LOG_TABS_ARTICLE" }]</a></li>
    <li><a href="#tabs-3">[{ oxmultilang ident="HD_LOG_TABS_DELETE" }]</a></li>
    <li><a href="#tabs-4">[{ oxmultilang ident="HD_LOG_TABS_IMAGE" }]</a></li>
    <li><a href="#tabs-5">[{ oxmultilang ident="HD_LOG_TABS_STOCK" }]</a></li>
    <li><a href="#tabs-6">[{ oxmultilang ident="HD_LOG_TABS_ERRORLOG" }]</a></li>
    <li><a href="#tabs-7">[{ oxmultilang ident="HD_LOG_TABS_CHANGELOG" }]</a></li>
  </ul>
  <div id="tabs-1">
